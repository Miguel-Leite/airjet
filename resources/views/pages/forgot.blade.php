...
@section('content')
  <div class="w-full h-[100vh] bg-zinc-300 flex items-center justify-center">
    <form action="#" method="post" class="w-4/12 mt-20 bg-white px-4 py-6 rounded">
      <strong class="leading-relaxed text-2xl text-blue-700">Esqueceste a senha?</strong>
      ...
      <div class="flex flex-col gap-2 mt-8">
        <button type="submit" class="p-2.5 rounded bg-blue-600 text-white font-medium transition hover:bg-blue-700">Enviar</button>
